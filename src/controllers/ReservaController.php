...
class ReservaController
{
    ...
    public function create()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') { // eu encontrei um problema no codigo onde dava dando para enviar preencher, então botei esse if para não acontecer.
            if (
            empty($_POST['data']) ||
...
// area para verificar a disponibilidade dos espaços
